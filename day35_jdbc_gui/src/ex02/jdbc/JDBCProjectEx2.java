...
public class JDBCProjectEx2 extends JFrame implements ActionListener{
    ...
    static PreparedStatement pstmtInsert,pstmtDelete,pstmtSelectAll,pstmtTotalScroll,pstmtSearch,pstmtSearchScroll;
    
    private static final String SQL_INSERT ="INSERT INTO CUSTOMERS VALUES(?,?,?,?)";
    private static final String SQL_DELETE ="DELETE CUSTOMERS WHERE BNO=?";
    private static final String SQL_SELECT ="SELECT * FROM CUSTOMERS";
    private static final String SQL_SEARCH ="SELECT * FROM CUSTOMERS WHERE NAME=?";
    private static final String SQL_UPDATE ="UPDATE CUTOMERS SET NAME=?,EMAIL=?,PHONE=?";
    ...
    public static void dbConnection() {
        try {
            ...
            pstmtTotalScroll = conn.prepareStatement(SQL_SELECT,
            ...
            pstmtSearchScroll = conn.prepareStatement(SQL_SELECT,
